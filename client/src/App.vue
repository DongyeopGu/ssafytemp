  ...
  <v-app id="app">
    <nav class="navbar navbar-expand-lg navbar-light py-1" style="background-color: #ffef90;" >
      <div class="container py-1" style=" margin-left: 0px; margin-right: 0px;" >
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
          <ul class="navbar-nav pl-0">
            ...
            <li class="nav-item">
              <router-link class="nav-link" to="/temperature">체온 확인</router-link>
            </li>
            <li class="nav-item">
      ...
      <div class="d-none d-sm-none d-md-block d-lg-block" style="width: 130px">
        <a href="http://edu.ssafy.com/" target="_blank" class="d-inline-block" style="margin-right : 5px"><img src="./assets/edussafy.png"  width="30" alt="edussafy" ></a>  
        <a href="http://project.ssafy.com/" target="_blank"><img src="./assets/projectssafy.png" width="30"  alt="projectssafy" class="d-inline-block" style="cursor:pointer"></a>
      </div>
    ...
    <footer class="site-footer">
      <div class="container" style=" max-width: 1300px;">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-7" style="text-align: left;">
            ...
            <p style="font-size:12px">(주)멀티캠퍼스 서울특별시 강남구 언주로 508 10-17층(역삼동, 서울상록빌딩) 고객센터 02-3429-5041 평일 상담시간 : 09:00 ~ 18:00</p>
            <p class="copyright-text">Copyright &copy; {{year}} All Rights Reserved by 
             <span style="cursor:pointer; color: #abcae0;" @click.stop="dialog = true">GOS</span>.
            </p>
          </div>
        </div>
      </div>
      <v-dialog
        ...
        >
        <v-card>
          <img src="./assets/member.png" width="600" alt="member">
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn
